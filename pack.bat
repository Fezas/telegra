...
set JAVA_VERSION=17
set MAIN_JAR=telegra-1.0-SNAPSHOT.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\fezas\telegra\TelegraStart.class > temp.txt
...
set manual_modules=,jdk.crypto.ec,jdk.localedata,javafx.controls,javafx.fxml,java.sql
...
call "%JAVA_HOME%\bin\jpackage" ^
  ...
  --name Telegra ^
  --main-class fezas.telegra.TelegraStart ^
  --main-jar %MAIN_JAR% ^
